 ...
 * @param int $order_id
 */
add_action('woocommerce_thankyou', 'enroll_update_order', 10, 1);
function enroll_update_order($order_id)
{
...
add_action( 'init', function() {
    if( !is_admin() ) {
        ...
        if ($a != null){
            remove_action( 'woocommerce_thankyou', 'enroll_update_order', 10, 1 );
